...
<div class="small-container single product">
    <div class="row">
        <div class="col-2">
            <img src="slikice/product1.jpg" width="100%" id="productImg" >

            <div class="small-img-row">
                <div class="small-img-col">
                    <img src="slikice/product1.jpg" width="100%" class="small-img">
                </div>
        ...
        <div class="col-2">
            ...
            <p>Potpuna hrana za odrasle mačke s govedinom, piletinom, ribom i povrćem

                REMI receptura s pažljivo odabranim kvalitetnim sastojcima potpun je i lakoprobavljiv dnevni obrok, koji objedinjuje tri slasna okusa u gurmanski doživljaj za mačke profinjenog ukusa.
                </p>
        </div>
    </div>
</div>
